...
@if(basicControl()->cookie_status == 1 && auth()->user())
    ...
    <div class="cookies-alert" id="cookiesAlert">
        ...
        <a href="javascript:void(0);" class="mt-2 cmn-btn3" type="button"
...
<script>
    ...
    root.style.setProperty('--primary', '{{basicControl()->primary_color ??'#8fb568'}}');
    root.style.setProperty('--bgDark', '{{basicControl()->secondary_color ??'#233645'}}');
</script>
