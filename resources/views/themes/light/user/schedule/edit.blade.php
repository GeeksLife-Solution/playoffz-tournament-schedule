...
@section('title',trans('Manage Schedule'))
@section('content')
    <div class="section">
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary btn-sm" href="{{route('user.listSchedule')}}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-center mb-3">{{$schedule->num_teams}} Player {{$schedule->sport}} Schedule</h3>
